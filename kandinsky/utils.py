...
def q_sample(x_start, t, schedule_name = "linear", num_steps = 1000, noise = None):
    ...
    return (_extract_into_tensor(sqrt_alphas_cumprod, t, x_start.shape) * x_start + _extract_into_tensor(sqrt_one_minus_alphas_cumprod, t, x_start.shape) * noise)
